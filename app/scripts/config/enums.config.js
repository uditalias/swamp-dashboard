...
angular.module('swamp.config')
  ...
  .constant('SETTING', {
    "VIEW_TYPE": "setting_view_type",
    "SPEECH_ENABLED": "setting_speech_enabled"
  })
  .constant('VIEW_TYPE', {
    "LIST": "list",
    "GRID": "grid"
  })
  .constant('SPEAKABLE_TEXT', {
    "ALL_SERVICES_STARTED": { text: "all swamp services has started", enqueue: true },
    "SERVICE_HIGH_CPU_USAGE": { text: "{0} processor usage has reached {1}%!", enqueue: false }
  });
