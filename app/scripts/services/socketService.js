...
angular.module('swamp.services').service('socketService', [

  'SOCKET_EVENTS', 'EVENTS', 'swampServicesManager', 'serializeService', 'env', '$rootScope', 'tokenService', 'speechService',
  function (SOCKET_EVENTS, EVENTS, swampServicesManager, serializeService, env, $rootScope, tokenService, speechService) {
      ...
      if (message && message.event) {
        switch (message.event) {
          ...
          case SOCKET_EVENTS.SWAMP_OUT:
            ...
            speechService.speakIfSpeakable(logMessage.text);
